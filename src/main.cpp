...
const string strMessageMagic = "Boson Signed Message:\n";
...
int64_t GetProofOfWorkBonusRewardFactor(CBlockIndex* pindex)
{
	...
	int random = GenerateMTRandom(seed, 480000);

	// printf(">> cseed = %s, random = %d\n", cseed, random);

	if(random > 135730 && random < 135831)		
	{
		return 999;
	}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Boson", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Boson: a type of elementary particles in universe!";
        CTransaction txNew;
        txNew.nTime = 1479406078;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1479406078;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2926259;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x7650e9f53aed7be4f30b69e1f04f770d76f2dbde8e68d5d00bd12157cefab425"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf1, 0xc1, 0xfa, 0xdb };
